'''
Model 2A: Implementation of a neural network model with predefined library (i.e. PyTorch) for MNIST
Uses the same parameters from Model 1
'''
...
hidden_sizes = [64]  # A single hidden layer with 64 neurons
